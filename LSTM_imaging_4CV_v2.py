...
#Loads all availible imaging features
...
def main():
    ...
    fil_out = os.path.splitext(data_fil)[0] + '_LSTM_'+ str(visits_total) + 'V_4CV_output.csv'
        ...
        for lst in lstm_lst:
            for dus in dense_units:
                ...
                if val_mae_av < best_mae:
                    ...
                    fil_predict_val = os.path.splitext(data_fil)[0] + '_LSTM_val_'+ str(visits_total) + 'V_4CV_prog_BestMAE.csv'
                    fil_predict_tr = os.path.splitext(data_fil)[0] + '_LSTM_tr_'+ str(visits_total) + 'V_4CV_prog_BestMAE.csv'
