...
def main():
    ...
    fil_out = os.path.splitext(fs_file)[0] + '_LSTM_'+ str(visits_total) + 'V_5CV_output.csv'
    ...
    #loops for 3 lists of sizes in layers
    for db in db_list:
        for lst in lstm_lst:
            for dus in dense_units:
                ...
                for train_index, val_index in kf.split(X):
                    ...
                    if temp2 < best_mae:
                        ...
                        fil_predict_val = os.path.splitext(fs_file)[0] + '_LSTM_val_'+ str(visits_total) + 'V_5CV_BestMAE.csv'
                        fil_predict_tr = os.path.splitext(fs_file)[0] + '_LSTM_tr_'+ str(visits_total) + 'V_5CV_BestMAE.csv'
